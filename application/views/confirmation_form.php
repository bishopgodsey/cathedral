...
data-bv-feedbackicons-validating="fa fa-spinner">
    <div>
        ...
        <div class="col-sm-2 col-md-8 col-lg-8">
            ...
            <input type="text" name="search" class="form-control input-lg" id="search" placeholder="Chercher par Numero carte de Bapteme, Nom ou Prenom" data-bv-notempty data-bv-notempty-message="Veuillez selectionner un chretien"/>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-6 col-lg-6">
            <div class="form-group">
                ...
                <input type="text" name="lieu_conf" class="form-control" id="lieu_conf" placeholder="Tapez quelques lettres pour selectionner" 
